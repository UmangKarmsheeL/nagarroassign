...
namespace Exercise12
{
    public static class LambdaAndDelegates
    {
        ...
        public static void Main(string[] args)
        {
            ...
            IEnumerable<int> even = list.Where(x =>
            { return x % 2 == 0; });
            Print("Even", even);
            ...
            Func<int, bool> ConditionLess = new(LessThanFive);
            ...
            Func<int, bool> Condition3k = new(x => x % 3 == 0);
            ...
            Func<int, bool> Condition3kplus1 = new(delegate (int x) {
                return x % 3 == 1;
            });
